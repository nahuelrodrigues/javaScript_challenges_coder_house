...
$("body").prepend('<div class="ads-popup" id="js-iframeremove" style="display: none"><div class="ads-popup-wrap"><div class="ads-popup-overlay"></div><div class="ads-popup-container"><img id="img-popup"src="images/pop-up.jpg" alt=""><div class="ads-popup-close">&times;</div></div></div></div>');
// que aparezca a los 5 secs de navegación
  $(".ads-popup").css("opacity", "1")
  .slideUp(2000)
  .delay(5000)
  .slideDown(2000);
